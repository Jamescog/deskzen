...
class AuditLog(Base):
    ...
    timestamp: Mapped[datetime] = mapped_column(DateTime, default=get_current_utc_time, nullable=False)
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "timestamp_ethiopian": get_current_ethiopian_time(self.timestamp).isoformat(),
        }